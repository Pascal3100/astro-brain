...
- **Macro 2 — Setup** ✅ (done 2026-07-08) : page Setup unifiée, network/IP, à propos (niveau monture, calibration ADXL345 ×2 et courses ALT retirés le 2026-07-17 ; GPS + calibration compass retirés le 2026-08-26 avec le module DroTek, remplacés par la carte Site d'observation — voir ADRs ; backlash mount-side reporté Macro 5)
