"""Fake partagé pour LIS3MDL — utilisé par les tests calibration service,
calibration routes, et sensors routes.

Le fake :

- Expose la signature attendue par l'adapter (``read_raw``).
