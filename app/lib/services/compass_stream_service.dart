...
/// `/sensors/compass/stream?hz=N` et expose un [stream] de [CompassReading].
///
/// - Chaque event `compass` est un payload JSON auto-suffisant.
...
class CompassStreamService {
  CompassStreamService({
    required this.host,
    this.hz = 5,
  ...
  final StreamController<CompassReading> _out =
  ...
  Stream<CompassReading> get stream => _out.stream;
