...
- [nexstar-capabilities.md](nexstar-capabilities.md) — ce que la lib `nexstarpy` 0.1.0 wrappe (et surtout ce qu'elle ne wrappe pas).
- [nexstar-protocol-reference.md](nexstar-protocol-reference.md) — référence complète du protocole NexStar (HC + AUX), avec les commandes documentées et reverse-engineered.
