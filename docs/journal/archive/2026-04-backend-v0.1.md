...
Sessions 1 à 5. Période couverte : du brainstorm initial (2026-04-15) à la complétion code du plan `2026-04-17-astro-brain-v01-backend.md` (2026-04-20), service tournant via systemd sur le Pi, 64 tests verts, checklist d'intégration hardware prête à dérouler.
