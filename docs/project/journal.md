...
**À faire (doc) :** journal à 6 sessions visibles (S26→S31) = **plafond atteint** ; archiver le thread liaison-monture par milestone une fois la chaîne E2E verte (ne pas le scinder en cours d'investigation).
