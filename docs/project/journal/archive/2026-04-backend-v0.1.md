# Archive — Backend v0.1 (avril 2026)

Sessions 1 à 7. Période couverte : du brainstorm initial (2026-04-15) à la clôture du milestone backend v0.1 — code complet (Tasks 1-17), revue + renforcement, validation physique GPS + compass, décision capteurs d'inclinaison ADXL345. Manque uniquement la passe monture (sections 3 et 7 de la checklist) en attente des connecteurs.
...
Capteurs commandés. Décision archivée dans `docs/project/decisions.md` (entrée 2026-04-24 « Accéléromètres simples plutôt que IMU 9DOF »).
