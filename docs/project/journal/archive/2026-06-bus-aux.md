# Archive journal — Liaison monture : bus AUX NexStar SLT (Sessions 26→30)

Milestone **fil matériel liaison monture** (Macro 1), première moitié : de l'identification du bus AUX NexStar SLT à la preuve de la cause racine **électrique** et au pivot **ESP32** (la monture bouge via le pont). Sessions 26→30, du 2026-06-05 au 2026-06-15. La suite du fil (RX 4093/comparateur LM2902, TX round-trip → 74HC125) continue dans le journal courant à partir de la Session 31.
