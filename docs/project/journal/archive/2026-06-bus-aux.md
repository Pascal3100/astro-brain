# Archive journal — Liaison monture : bus AUX NexStar SLT (Sessions 26→32)

Milestone **fil matériel liaison monture** (Macro 1), première moitié : de l'identification du bus AUX NexStar SLT à la preuve de la cause racine **électrique** et au pivot **ESP32** (la monture bouge via le pont). Sessions 26→32, du 2026-06-05 au 2026-06-19. La suite du fil (comparateur LM2902 → RX prouvée, TX round-trip → 74AHCT125, jalon C validé) continue dans le journal courant à partir de la Session 33.
