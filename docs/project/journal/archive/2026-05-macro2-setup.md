# Archive — Macro 2 Setup (Sessions 17 → 19, mai 2026)

Archive des sessions courantes ayant livré 80 % de la Macro 2 Setup (Slices INFRA / A capteurs / B courses ALT / C À propos). Slice D (backlash + cordwrap) reste bloqué dongle CP2102 et sera repris à la livraison du dongle.
...
Sessions 11-14 archivées dans [`2026-04-v02-setup-prep.md`](2026-04-v02-setup-prep.md) (milestone : préparation v0.2 Setup — brainstorm, doc tree, recherche protocole NexStar, scaffold #8 Réseau). Journal courant : Sessions 15-19 (5 sessions, sous le plafond).
